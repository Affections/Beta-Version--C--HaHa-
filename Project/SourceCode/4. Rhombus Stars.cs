    ...
    class StandardInputTest
    {
        static void Main()
        {
            try
            {
                ...
                solutionWR6.Write("20" + "\n");
                authorSolutionWR6.Write("20" + "\n");
            ...
            catch (Exception)
            {
                ...
                Console.ForegroundColor = ConsoleColor.Green;
                Console.Write("'Rhombus of Stars' ");
                Console.ForegroundColor = ConsoleColor.White;
